      ...
      <main>
        <section className="hero">
          <div className="hero-text">
            ...
            <p>
              Welcome to Savannah Bites, where every dish tells a story of
              tradition, flavor, and passion. Our expert chefs bring the vibrant
              tastes of African cuisine right to your plate, creating an
              unforgettable dining experience. From rich spices to fresh,
              authentic ingredients, each meal celebrates the heart and soul of
              home-cooked goodness, creating an unforgettable dining experience
              designed to bring you closer to the warmth of these cherished
              culinary traditions.
            </p>
            ...
            <div class="button-container">
              ...
              <button
                ...
                className="btn-home-reservation"
              >
                Online Reservation
              </button>
            </div>
        ...
        <section className="featured-dishes">
          <div className="dish-card">
            ...
            <div className="dish-info">
              ...
              <p>
                Our signature spicy rice dish, perfectly seasoned and served
          ...
          <div className="dish-card">
            ...
            <div className="dish-info">
              ...
              <p>
                Smooth cornmeal porridge paired with our zesty vegetable relish
          ...
          <div className="dish-card">
            ...
            <div className="dish-info">
              ...
              <p>
                A beloved South African dish featuring spiced minced meat topped
        ...
        <section className="info-blocks">
          <div className="info-block">
            ...
            <p>
              Our dishes are crafted from authentic recipes passed down through
              generations, preserving the true essence of African cuisine.
            </p>
          </div>
          ...
          <div className="info-block">
            ...
            <h3>Expert Chefs</h3>
            <p>
              Our team of skilled chefs brings years of experience in authentic
              African cuisine, ensuring every dish is a masterpiece.
            </p>
          </div>
          ...
          <div className="info-block">
            ...
            <p>
              We source the finest local and imported ingredients to create
              authentic flavors that transport you straight to Africa.
            </p>
          </div>
        </section>
        ...
        <section className="testimonials">
          ...
          <div className="testimonial-grid">
            ...
            <div className="testimonial-card">
              <div className="quote">
                "Amazing flavors and excellent service. The Pap & Chakalaka
                brought back memories of my grandmother's cooking."
              </div>
            ...
            <div className="testimonial-card">
              <div className="quote">
                "A must-visit restaurant! The authenticity of the dishes and the
                warm atmosphere make it special."
              </div>
